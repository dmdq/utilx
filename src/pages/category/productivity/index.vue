<template>
  <div class="max-w-8xl mx-auto">
    <!-- 增强型头部 -->
    <div class="mt-4 mb-8">
      <h1 class="text-3xl font-bold mb-3">在线效率工具箱</h1>
      <p class="text-muted-foreground max-w-3xl">专业的剪贴板管理、效率提升工具，帮助您提高工作效率，简化日常操作。</p>
    </div>
    ...
    <!-- SEO知识库区域 -->
    <SeoKnowledgeBase category="productivity" />
  </div>
</template>
